...
import MSMSeeder
import MSMSeeder.attic.packaging
...
if args.package_for == 'transfer':
    MSMSeeder.attic.packaging.package_for_transfer(process_only_these_targets=args.targets)

elif args.package_for == 'FAH':
    MSMSeeder.attic.packaging.package_for_fah(process_only_these_targets=args.targets, nclones=args.nFAHclones, archive=args.archiveFAHproject)
